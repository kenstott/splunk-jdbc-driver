...
public class SplunkDriverTest {
    ...
    public void setUp() {
        ...
        try {
            ...
            fail("com.kenstott.SplunkDriver not found");
        }
    }
    ...
    public void testDriverRegistration() throws SQLException {
        ...
        // Test that our com.kenstott.SplunkDriver can be instantiated directly
        com.kenstott.SplunkDriver splunkDriver = new com.kenstott.SplunkDriver();
        assertNotNull("com.kenstott.SplunkDriver should be instantiable", splunkDriver);
        assertTrue("com.kenstott.SplunkDriver should accept Splunk URLs", splunkDriver.acceptsURL("jdbc:splunk:"));
    }
    
    @Test
    public void testAcceptsURL() throws SQLException {
        com.kenstott.SplunkDriver driver = new com.kenstott.SplunkDriver();
